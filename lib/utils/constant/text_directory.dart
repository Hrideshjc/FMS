...
class UIStrings {
  static get appName => Constants.currentLang == Lang.ENG
      ? "Futsal Management System"
      : "काठमाडौँ महानगरपालिका नगर";
  ...
  static get passwordEnter => Constants.currentLang == Lang.ENG
      ? "Enter your Password"
      : "आफ्नो पासवर्ड प्रविष्ट गर्नुहोस्";

  static get conformPasswordEnter =>
      Constants.currentLang == Lang.ENG ? "Confirm Password" : "पासवर्ड अनुरूप";

  static get forgetPassword => Constants.currentLang == Lang.ENG
      ? "Forgot your password?"
      : "पासवर्ड बिर्सनुभयो ?";

  static get signUp =>
      Constants.currentLang == Lang.ENG ? "Sign Up" : "साइन अप !";

  static get nepali => Constants.currentLang == Lang.ENG ? "Nepali" : "नेपाली";

  static get english =>
      Constants.currentLang == Lang.ENG ? "English" : "अंग्रेजी";
...
/*------------- Validation --------------*/
class UITextValidation {
  static get matchPassword => Constants.currentLang == Lang.ENG
      ? "Passwords do not match."
      : "पासवर्डहरू मेल खाँदैनन्।";

  static get requiredValue =>
      Constants.currentLang == Lang.ENG ? "* Required" : "* आवश्यक छ";

  static get mustBe8Password => Constants.currentLang == Lang.ENG
      ? "Password should be least 8 characters"
      : "पासवर्ड कम्तिमा ८ वर्णको हुनुपर्छ";

  static get mustBe15Password => Constants.currentLang == Lang.ENG
  ...
  static get atLeastPhoneNumber => Constants.currentLang == Lang.ENG
      ...
      : "फोन कम्तिमा 6 वर्णको हुनुपर्छ";

  static get greaterPhoneNumber => Constants.currentLang == Lang.ENG
      ? "Phone should not be greater than 10 characters"
      : "फोन 10 वर्ण भन्दा बढी हुनु हुँदैन";
}
